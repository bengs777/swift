...
1. Open the editor
2. In model selector dropdown, choose "Orchestrator - Deepseek V4 Flash (5000/req)"
3. Write your prompt
4. Click "Generate"
5. 5,000 IDR will be deducted from balance
...
**Fix**: User needs to top-up (need 5,000 IDR minimum)
...
### vs V0
- Same cost (5,000 IDR)
- Different model (deepseek vs v0-web-generator)
