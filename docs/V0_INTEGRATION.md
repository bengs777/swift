# V0.app AI Integration - 5000 IDR per Request

Dokumentasi lengkap integrasi V0.app sebagai AI code generator dengan sistem pricing 5000 IDR per request.

## Overview

Sistem ini mengintegrasikan V0.app sebagai provider AI untuk generate code dengan model pricing:
- **Cost**: 5000 IDR per request (1x generate/prompt)
...
1. **V0 Provider** (`lib/ai/providers/v0-provider.ts`)
   ...
   - Cost calculation (5000 IDR fixed)
...
```json
{
  ...
  "requiredAmount": 5000,
  "shortfall": 2000,
  "message": "Balance tidak cukup. Diperlukan Rp 5.000, saldo Anda: Rp 3.000"
}
```
...
1. Deduct 5000 IDR dari user balance
...
```
Cost per generation = 5000 IDR (fixed)

Example:
- User balance: 100,000 IDR
- Available generations: 100,000 / 5,000 = 20 generations
- After 1 generation: 100,000 - 5,000 = 95,000 IDR
```
