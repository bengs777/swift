...
Orchestrator uses OpenRouter to provide the deepseek/deepseek-v4-flash model. Setup is simple:
...
**"Orchestrator - Deepseek V4 Flash (5000/req)"**
...
- **Multiple Models**: Access to 200+ models beyond just Deepseek
- **Fair Pricing**: Competitive pricing for deepseek-v4-flash
...
# 3. Go to editor and select "Orchestrator - Deepseek V4 Flash (5000/req)"
...
- User needs at least 5,000 IDR for one generation
...
- Check deepseek/deepseek-v4-flash is available on OpenRouter

## Switching Models

Orchestrator is hardcoded to use `deepseek/deepseek-v4-flash`. To use a different OpenRouter model:

Edit `lib/ai/providers/orchestrator-provider.ts`:

```typescript
const ORCHESTRATOR_MODEL = "deepseek/deepseek-v4-flash" // Change this
```
