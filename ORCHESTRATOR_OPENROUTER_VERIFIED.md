...
User enters prompt in editor
        ↓
Selects "Orchestrator - Deepseek V4 Flash (5000/req)" model
        ↓
Clicks Generate
        ↓
Frontend calls POST /api/generate/orchestrator
        ↓
Backend checks user balance (needs ≥ 5,000 IDR)
        ↓
...
- [ ] Check model selector shows "Orchestrator - Deepseek V4 Flash (5000/req)"
- [ ] Select model
- [ ] Enter prompt: "Create a simple React counter component"
- [ ] Click Generate
- [ ] Verify code is generated and shown in preview
- [ ] Check balance was deducted by 5,000 IDR
...
5. Users can generate code using deepseek/deepseek-v4-flash
6. Each generation costs 5,000 IDR
