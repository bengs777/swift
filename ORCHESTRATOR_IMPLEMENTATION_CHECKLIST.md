...
- [x] `lib/ai/providers/orchestrator-provider.ts` (116 lines)
  ...
  - [x] getModel() - returns "deepseek/deepseek-v4-flash"
...
- [x] `app/api/generate/orchestrator/route.ts` (121 lines)
  ...
  - [x] Balance verification (5000 IDR)
...
- [x] `lib/services/generate-billing.service.ts`
  ...
  - [x] Added 5000 IDR cost breakdown
...
- [x] `app/api/models/route.ts`
  ...
  - [x] Shows "Orchestrator - Deepseek V4 Flash (5000/req)"
...
|---------|-----|-------------|--------|
| Model | v0-web-generator | deepseek-v4-flash | ✅ Different |
| Cost | 5000 IDR | 5000 IDR | ✅ Same |
...
5. **Model Hardcoded**: deepseek-v4-flash only (can be made configurable)
