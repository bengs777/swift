...
Orchestrator has been successfully integrated as an AI code generation provider with the **deepseek/deepseek-v4-flash** model, priced at **5,000 IDR per request**.
...
3. **Use in Editor**
   ...
   - Select "Orchestrator - Deepseek V4 Flash (5000/req)" from model dropdown
   - Write your prompt and generate code
   - 5,000 IDR will be deducted from user balance
...
✅ **Fixed Pricing** - 5,000 IDR per request
...
| Item | Amount | Notes |
|------|--------|-------|
| Per Request | 5,000 IDR | Fixed cost |
| Failed Request | Free | No charge on error |
| Minimum Balance | 5,000 IDR | To generate |
...
# Should show "Orchestrator - Deepseek V4 Flash (5000/req)"
```
...
**Fix**: User needs to top-up balance (need 5,000 IDR minimum)
...
|---------|-------------|-----|--------|
| Model | deepseek-v4-flash | v0-web-generator | gpt-4/etc |
| Cost | 5,000 IDR | 5,000 IDR | Variable |
...
- Deepseek Model: [https://deepseek.com](https://deepseek.com)
