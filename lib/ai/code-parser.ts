...
function normalizeLanguage(value: unknown): GeneratedFile["language"] {
  const supported: GeneratedFile["language"][] = ["tsx", "ts", "css", "json", "html", "prisma", "md", "env"]
  const candidate = typeof value === "string" ? value.toLowerCase() : ""
  return supported.includes(candidate as any) ? (candidate as GeneratedFile["language"]) : "tsx"
}
